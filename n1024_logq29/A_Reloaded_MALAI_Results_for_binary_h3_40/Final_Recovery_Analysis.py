...
MAX_SAMPLES = 1_000_000  # Maximum allowed samples
            ...
            if samples_info != "Not achieved":
                try:
                    ...
                    if samples > MAX_SAMPLES:
                        continue  # Skip if sample count exceeds 1 million
                    if current_hamming_weight not in min_no_mod or no_mod_percentage < min_no_mod[current_hamming_weight]:
...
# Process the files for 10% and 100% recovery
min_no_mod_10, min_samples_10 = process_file("Minimum_samples_required_for_10_Percent_Recovery_for_h3_40_binary.txt")
min_no_mod_100, min_samples_100 = process_file("Minimum_samples_required_for_100_Percent_Recovery_for_h3_40_binary.txt")
...
output_filename = "Final_Recovery_Analysis_N_1024_Q_29_binary.xlsx"
...
transposed_filename = "Final_Transposed_Recovery_Analysis_N_1024_Q_29_binary.xlsx"
