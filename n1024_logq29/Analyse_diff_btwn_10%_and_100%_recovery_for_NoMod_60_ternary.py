...
start_hwt = 3
end_hwt = 40
nomod_percentage = 0.60  # ternary recovery
Q = 274887787
half_value = Q // 2

models = [LinearRegression(), OrthogonalMatchingPursuit()]

output_dir = f"Analysis_for_difference_between_10_and_100_percent_recovery_ternary"
os.makedirs(output_dir, exist_ok=True)
output_filename = os.path.join(
    output_dir, 
    f"Analysis_for_difference_between_10_and_100_percent_recovery_for_Nomod_{nomod_percentage*100:.0f}%_ternary.txt"
)
