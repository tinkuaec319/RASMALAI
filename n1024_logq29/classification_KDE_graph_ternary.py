...
for hamming_weight in hamming_weights:
    ...
    plt.title(f'Distribution of Summation of Columns of A for HWt = {hamming_weight}_ternary')
    plt.legend()
    ...
    # Save the plot
    output_image_file = f'Kernel_Density_Estimation_KDE_hwt_{hamming_weight}_ternary.png'
