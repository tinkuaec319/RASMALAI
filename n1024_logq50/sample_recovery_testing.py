...
models = [
    LinearRegression(),
    ElasticNet(alpha=1000.0, l1_ratio=0.5, max_iter=100000),
...
for num_samples in num_samples_list:
    ...
    output_filename = f"Sample_Secret_recovery_testing_for_{num_samples}_samples_with_Nomod_{no_mod_percentage}%.txt"
