...
# Initialize all secrets as recovered (True)
secret_recovery_status = {
    (hwt, iter): True 
    for hwt in range(3, 41)  # Hamming weights 3-40 inclusive
    for iter in range(10)    # 10 iterations per weight
}

# Specific 16 unrecovered positions from results file
unrecovered_positions = [
    (3, 0)
]

# Mark unrecovered positions as False
for hwt, iter in unrecovered_positions:
    secret_recovery_status[(hwt, iter)] = False
