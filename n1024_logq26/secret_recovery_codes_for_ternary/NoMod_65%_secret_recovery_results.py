...
for hwt in [3,4,5,6,7,33,34,36,37,40]:
...
# num_samples_list = [20000, 50000, 100000, 200000, 500000, 1000000]
...
for num_samples in num_samples_list:
    output_dir = f"NoMod_{nomod_percentage*100:.0f}%_results_for_h{start_hwt}_{end_hwt}_ternary"  # Dynamic percentage
